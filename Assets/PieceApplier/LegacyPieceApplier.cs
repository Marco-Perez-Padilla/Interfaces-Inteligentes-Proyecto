...
public class LegacyPieceApplier : MonoBehaviour
{
    ...
    /// todas las piezas y sus TriggerNotificators están disponibles.
    /// </summary>
    ...
    private void ApplyPiecesToPath(List<PathNode> path, Color color)
    {
        ...
        for (int i = 1; i < path.Count; i++)
        {
            ...
            else if (numberOfWayouts == 2)
            {
                ...
                //a veces el codigo de alvaro hace que un nodo que solo tiene una salida (o sea con forma de L) diga que tiene dos salidas con la misma posici�n
